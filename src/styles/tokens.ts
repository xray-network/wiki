/**
 * Design tokens mirrored from xray-app/packages/frontend/app/shared/design-system/tokens.ts.
 * Keep Rspress, Ant Design, and utility styles aligned with these values.
 */
